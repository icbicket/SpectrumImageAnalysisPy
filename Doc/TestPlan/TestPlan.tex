...
\an{test RL deconvolution algorithm - SNR vs # iterations}
\an{test RL deconvolution algorithm - deviation from 'real' spectrum (simulated) vs # iterations (compare to 'real' spectrum)}
\an{test RL deconvolution - time vs SI size, time vs # iterations (parallel processing) - non-functional req's}
