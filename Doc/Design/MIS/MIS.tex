...
\hline
ReadDM3 & - & - & - \\
VerifyFile & - & - & Exceptions related to wrong or bad input\\
\hline
\end{tabular}
\end{center}
\an{file contains wrong data type, file is empty, file is not dm3, ...}
...
\end{tabular}
\end{center}
\an{Need to think on this more, if I treat this as a template module, does it have exported access programs?}
