...
\begin{description}
	...
	\item The headings or data format of saved spectrum csv files.
	\item The locations/labels of data and metadata inside dm3 files.
	\item Expanding support to dm4 files.
	\item Functions used for deconvolution (optimizations for reduced error or speed).
	\item The locations/labels of data and metadat inside h5 files.
	\item The data type inside h5 files.
	\item The data type inside dm3 files.
	\item 
	\item[\refstepcounter{acnum} \actheacnum \label{acImport}:] The format of import data.
...
\begin{description}
	...
	\item[Services:]Extract 1D, 2D, and 3D segmentns of data, as desired by the user.
	\item[Implemented By:] --
\end{description}
...
\begin{table}[H]
	...
	\begin{tabular}{p{0.2\textwidth} p{0.6\textwidth}}
		...
		\midrule
		R1 & \mref{mHH}, \mref{mdm3Im}, \mref{mh5Im}, \mref{m3DSIdata}\\
		R2 & \mref{mHH}, \mref{mcsvIm}, \mref{m1Dspecdata}\\
		R3 & \mref{mcsvIm}, \mref{mdm3Im}, \mref{mh5Im}, \mref{mrplIm}\\
		R4 & \mref{mpngEx}, \mref{m1Dslice}, \mref{m3Dmask}, \mref{m1Dspecdisplay}, \mref{m2Dimgdisplay}, \mref{m3DSIdisplay}\\
		R5 & \mref{mcsvEx}, \mref{m2Dmask}, \mref{m3Dmask}, \mref{m1Dspecdisplay}, \mref{m2Dimgdisplay}, \mref{m3DSIdisplay}\\
		R6 & \mref{mRL}, \mref{m3DSIdisplay}, \mref{m1Dspecdata}, \mref{m3DSIdata}\\
		R7 & \mref{mNorm}, \mref{m1Dslice}, \mref{m3DSIdata}\\
		R8 & \mref{mBkgnd}, \mref{m1Dspecdata}, \mref{m3DSIdata}\\
		R9 & \mref{mGain}, \mref{m1Dspecdata}, \mref{m3DSIdata}\\
		\bottomrule
	\end{tabular}
