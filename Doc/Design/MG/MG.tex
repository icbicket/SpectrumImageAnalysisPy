...
\multirow{18}{0.25\textwidth}{Behaviour-Hiding Module} & \multirow{5}{0.25\textwidth}{I/O} & *.h5 \\
& & *.dm3\\
& & *.png\\
& & *.csv\\
& & *.rpl\\\cline{2-3}
...
\multirow{2}{0.25\textwidth}{Software Decision Module} & Array data structure\\
& Plotting structure\\
\bottomrule
