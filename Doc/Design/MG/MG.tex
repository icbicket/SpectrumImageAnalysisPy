...
\item [\refstepcounter{mnum} \mthemnum \label{mdm3}:] I/O *.dm3 Module
\item [\refstepcounter{mnum} \mthemnum \label{mh5}:] I/O *.h5 Module
\item [\refstepcounter{mnum} \mthemnum \label{mrpl}:] I/O *.rpl Module
\item [\refstepcounter{mnum} \mthemnum \label{mcsv}:] I/O *.csv Module
\item [\refstepcounter{mnum} \mthemnum \label{mpng}:] I/O *.png Module
...
\multirow{18}{0.25\textwidth}{Behaviour-Hiding Module} & \multirow{5}{0.25\textwidth}{I/O} & *.dm3 \\
& & *.h5\\
& & *.rpl\\
& & *.csv\\
& & *.png\\\cline{2-3}
