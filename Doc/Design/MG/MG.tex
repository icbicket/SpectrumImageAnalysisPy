...
\begin{description}
	...
	\item [\refstepcounter{mnum} \mthemnum \label{mArrayStruct}:]
    \hyperref[sssec:ArrayStruct]{Array Data Structure}. \wss{The more abstract
        notion of sequence hiding might be better
